...
class HiddenLayer(object):
    def __init__(self, rng, input, n_in, n_out, W=None, b=None,
                 activation=T.tanh, w_noise=1e-6):
        """
        ...
        rn_W = srng.normal(W.shape, std=w_noise)

        lin_output = T.dot(input, self.W + rn_W) + self.b
        self.output = (
    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        for minibatch_index in range(n_train_batches):
            ...
            if adverse is None:
                ...
                cost_ij = train_model(minibatch_index, adverse)
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if adverse is None:
                    ...
                    validation_losses = [validate_model(i, adverse) for i
                                         in range(n_valid_batches)]
