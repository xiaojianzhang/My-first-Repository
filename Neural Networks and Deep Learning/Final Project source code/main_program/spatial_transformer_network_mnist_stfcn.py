...
def test_mnist_stfcn(datadir='',modalname='TC',DIM=60,LEARNING_RATE = 0.001,NUM_EPOCHS=50):
    BATCH_SIZE = 100
    NUM_CLASSES = 10
    ...
    def build_model(input_width, input_height, output_dim,
        ...
        loc_l0 = dense(l_in, num_units=32,nonlinearity=relu)
        loc_l1 = dense(loc_l0, num_units=32, nonlinearity=relu)
        loc_l2 = dense(loc_l1, num_units=32, nonlinearity=relu)
        
        loc_out = dense(loc_l2, num_units=6, b=b, W=lasagne.init.Constant(0.0),nonlinearity=lasagne.nonlinearities.identity)
        ...
        # 128 ~ 256
        class_l1 = dense(l_trans1,num_filters=200,nonlinearity=relu,W=ini)
        class_l2 = dense(class_l1,num_filters=200,nonlinearity=relu,W=ini)
        
        
        l_out = dense(class_l2,num_units=output_dim,nonlinearity=lasagne.nonlinearities.softmax,W=ini)
