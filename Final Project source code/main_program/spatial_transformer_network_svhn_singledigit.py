...
def load_data():
    ...
    data=loadmat('train_SVHN.mat')
    X_train0 = data['train_SVHN'].transpose()
    
    data=loadmat('test_SVHN.mat')
    X_test = data['test_SVHN'].transpose()

    data=loadmat('train_SVHN_label.mat')
    y_train0 = np.squeeze(data['train_SVHN_label'])
    
    data=loadmat('test_SVHN_label.mat')
    y_test = np.squeeze(data['test_SVHN_label'])
    
    X_train = X_train0[:120000]
    y_train = y_train0[:120000]
    
    X_valid = X_train0[-26514:]
    y_valid = y_train0[-26514:]
...
def build_model(input_width, input_height, output_dim,
    ...
    l_out = dense(class_l8,num_units=output_dim,nonlinearity=lasagne.nonlinearities.softmax,W=ini)
