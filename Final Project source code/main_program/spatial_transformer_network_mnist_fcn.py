...
def test_mnist_fcn(datadir='',modalname='TC',DIM=60,LEARNING_RATE = 0.001,NUM_EPOCHS=50):
    ...
    def build_model(input_width, input_height, output_dim,
        ...
        # 128 ~ 256
        class_l1 = dense(l_in,num_units=200,nonlinearity=relu,W=ini)
        class_l2 = dense(class_l1,num_units=200,nonlinearity=relu,W=ini)
