...
def test_mnist_cnn(datadir='',modalname='TC',DIM=60,LEARNING_RATE = 0.001,NUM_EPOCHS=50,BATCH_SIZE=256):
    ...
    def build_model(input_width, input_height, output_dim,
        ...
        # 32 ~ 64
        class_l0 = pool(l_in,pool_size=(2,2),stride=2)
        class_l1 = conv(class_l0,num_filters=48,filter_size=(9, 9),nonlinearity=relu,W=ini)
        class_l2 = pool(class_l1, pool_size=(2, 2),stride=2)
        class_l3 = conv(class_l2,num_filters=48,filter_size=(7, 7),nonlinearity=relu,W=ini)
